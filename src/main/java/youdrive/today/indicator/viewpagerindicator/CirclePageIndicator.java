...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    static class SavedState extends BaseSavedState {
        ...
        /* renamed from: youdrive.today.indicator.viewpagerindicator.CirclePageIndicator.SavedState.1 */
        static class C17401 implements Creator<SavedState> {
            C17401() {
            }
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, C1733R.attr.vpiCirclePageIndicatorStyle);
    }
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!isInEditMode()) {
            ...
            int defaultPageColor = res.getColor(C1733R.color.default_circle_indicator_page_color);
            int defaultFillColor = res.getColor(C1733R.color.default_circle_indicator_fill_color);
            int defaultOrientation = res.getInteger(C1733R.integer.default_circle_indicator_orientation);
            int defaultStrokeColor = res.getColor(C1733R.color.default_circle_indicator_stroke_color);
            float defaultStrokeWidth = res.getDimension(C1733R.dimen.default_circle_indicator_stroke_width);
            float defaultRadius = res.getDimension(C1733R.dimen.default_circle_indicator_radius);
            boolean defaultCentered = res.getBoolean(C1733R.bool.default_circle_indicator_centered);
            boolean defaultSnap = res.getBoolean(C1733R.bool.default_circle_indicator_snap);
            TypedArray a = context.obtainStyledAttributes(attrs, C1733R.styleable.CirclePageIndicator, defStyle, 0);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case C1733R.styleable.ViewPagerIndicator_vpiUnderlinePageIndicatorStyle /*5*/:
                ...
                break;
            case C1733R.styleable.Toolbar_contentInsetEnd /*6*/:
    ...
    private int measureLong(int measureSpec) {
        ...
        if (specMode == Target.SIZE_ORIGINAL) {
