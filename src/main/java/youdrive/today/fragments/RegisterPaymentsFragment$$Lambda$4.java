...
final /* synthetic */ class RegisterPaymentsFragment$$Lambda$4 implements Action1 {
    private final RegistrationActivity arg$1;

    private RegisterPaymentsFragment$$Lambda$4(RegistrationActivity registrationActivity) {
        this.arg$1 = registrationActivity;
    }

    private static Action1 get$Lambda(RegistrationActivity registrationActivity) {
        return new RegisterPaymentsFragment$$Lambda$4(registrationActivity);
    }
