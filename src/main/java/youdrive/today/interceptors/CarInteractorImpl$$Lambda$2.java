...
final /* synthetic */ class CarInteractorImpl$$Lambda$2 implements Action1 {
    private final CarInteractorImpl arg$1;

    private CarInteractorImpl$$Lambda$2(CarInteractorImpl carInteractorImpl) {
        this.arg$1 = carInteractorImpl;
    }

    private static Action1 get$Lambda(CarInteractorImpl carInteractorImpl) {
        return new CarInteractorImpl$$Lambda$2(carInteractorImpl);
    }
